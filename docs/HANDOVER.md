...
1. **真机手测仅部分完成**（2026-08-02 用户录屏实测）：首次指引、设置（含备份/恢复按钮）、保存血压、知识页、导出报告已验证正常。**仍未验证**：`tel:120` 拨号唤起、震动反馈、剪贴板复制、微信内置浏览器行为、360px 小屏布局、训练与用药的完整操作流程。DEVELOPMENT.md §7 有完整手工回归清单。
